...
For more targeted or structured queries, plugins can define connector-type [data tools](/tools#connector) that map parameters to specific connector resources and filters.
